...
echo * 11. Outros/Zenfone               *
echo * 12. Flipboard                    *
echo * 13. Social                       *
echo * 14. One Plus                     *
echo * 15. Leitura de bateria           *
echo * 16. Densidade da Tela            *
echo * 17. Tamanho da Tela              *
echo * 18. Recuperar                    *
echo * 19. Modo De Download             *
echo * 20. Modo De Fastboot             *
echo * 21. Reiniciar                    *
echo * 22. Perfomace de Hz              *
echo * 23. Tela Suave                   *
echo  ===================================
